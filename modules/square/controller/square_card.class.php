...
//require attach_class.php
    ...
    function Write($ATTACH_CLASS, $PUSH_CLASS, $square_srl, $parent_card_srl, $page_srl, $user_srl, $content, $align, $style, $background, $permission, $status, $privacy)
    {
...
//	$user_srl = AuthCheck($user_srl, false);
        ...
        if ($content != "") {
            ...
            $result = Model_SquareCards_Write($page_srl, $user_srl, $square_srl, $parent_card_srl, null, $content, $align, $style, $background, $permission, $status, $privacy, $attach_result);
