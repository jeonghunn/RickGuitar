...
<script>
    ...
    function addCard() {
        ...
        $('<div class="outer"> <div class="tablerow"><div class="squarecard"><textarea class="cardtextarea" placeholder="내용을 입력해주세요."  id="contents_' + cardcount + '" ></textarea> <label class="radio-inline"><input type="radio" name="align_radio_1" id="alignradio_center_1" value="center" checked>가운데 정렬</label><label class="radio-inline"><input type="radio" name="align_radio_1" id="inlineRadio_left_1" value="left"> 왼쪽 정렬</label> <br> </div></div></div><br>').insertBefore('#squarecard');
