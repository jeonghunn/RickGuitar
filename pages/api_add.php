...
<input type="text" class="form-control has-error" name="api_name" placeholder="<? S('API_api_name')?>" required><br>
<textarea class="form-control has-error" rows="5" name="api_description" style="resize: none;" placeholder="<? S('API_description')?>" required></textarea>
