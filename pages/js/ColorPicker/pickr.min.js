! function(t, e) {
    ...
    return function(t) {
        ...
        const i = r.bind(null, "addEventListener"),
            s = r.bind(null, "removeEventListener");
        ...
        function h(t) {
            ...
            function n(n) {
                ...
                let r = s,
                    a = "";
                for (let t = s - 1; t > 0 && o(i[t]); t--) a = i[t] + a, r--;
                for (let t = s, e = i.length; t < e && o(i[t]); t++) a += i[t];
                if (a.length > 0 && !isNaN(a) && isFinite(a)) {
                    const o = n.deltaY < 0 ? 1 : -1,
                        s = n.ctrlKey ? 5 * o : o;
                    let c = Number(a) + s;
                    !e && c < 0 && (c = 0);
                    const l = i.substr(0, r) + c + i.substring(r + a.length, i.length),
                        p = r + String(c).length;
                    t.value = l, t.focus(), t.setSelectionRange(p, p)
                }
                n.preventDefault(), t.dispatchEvent(new Event("input"))
            }
            i(t, "focus", () => i(window, "wheel", n)), i(t, "blur", () => s(window, "wheel", n))
        }
        ...
        function u(t, e) {
            return function(t) {
                ...
                var o = [],
                    ...
                    s = void 0;
                try {
                    for (var r, a = t[Symbol.iterator](); !(n = (r = a.next()).done) && (o.push(r.value), !e || o.length !== e); n = !0);
                } catch (t) {
                    i = !0, s = t
                } finally {
                    try {
        ...
        function v(t, e, o) {
            ...
            let n = Math.floor(t),
                ...
                a = o * (1 - (1 - i) * e),
                c = n % 6;
            return [255 * [o, r, s, s, a, o][c], 255 * [a, o, o, r, s, s][c], 255 * [s, s, a, o, o, r][c]]
        }

        function y(t, e, o) {
            let n, i, s;
            const r = d(t /= 255, e /= 255, o /= 255),
                a = f(t, e, o),
                c = a - r;
            if (0 === c) n = i = 0;
            else {
                ...
                let s = ((a - t) / 6 + c / 2) / c,
                    r = ((a - e) / 6 + c / 2) / c,
                    l = ((a - o) / 6 + c / 2) / c;
                t === a ? n = l - r : e === a ? n = 1 / 3 + s - l : o === a && (n = 2 / 3 + r - s), n < 0 ? n += 1 : n > 1 && (n -= 1)
            }
            return [360 * n, 100 * i, 100 * (s = a)]
        }

        function m(t, e, o, n) {
            return e /= 100, o /= 100, [...y(255 * (1 - d(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - d(1, e * (1 - n) + n)), 255 * (1 - d(1, o * (1 - n) + n)))]
        }
                ...
                if (n = e[r].exec(t)) switch (r) {
                    case "cmyk":
                    {
                        let t = u(o(n), 5),
                            ...
                            s = t[3],
                            a = t[4];
                        if (e > 100 || i > 100 || s > 100 || a > 100) break;
                        return {
                            values: [...m(e, i, s, a), 1],
                            type: r
                        }
                    ...
                    case "rgba":
                    {
                        let t = u(o(n), 6),
                            ...
                            a = t[5],
                            c = void 0 === a ? 1 : a;
                        if (e > 255 || i > 255 || s > 255 || c < 0 || c > 1) break;
                        return {
                            values: [...y(e, i, s), c],
                            type: r
                        }
                    ...
                    case "hsla":
                    {
                        let t = u(o(n), 6),
                            ...
                            a = t[5],
                            c = void 0 === a ? 1 : a;
                        if (e > 360 || i > 100 || s > 100 || c < 0 || c > 1) break;
                        return {
                            values: [...g(e, i, s), c],
                            type: r
                        }
            ...
            const i = Math.ceil,
                s = {
                    ...
                    toHSVA() {
                        const t = [s.h, s.s, s.v],
                            e = t.map(i);
                        return t.push(s.a), t.toString = (() => `hsva(${e[0]}, ${e[1]}%, ${e[2]}%, ${s.a.toFixed(1)})`), t
                    },
                    toHSLA() {
                        const t = function(t, e, o) {
                            ...
                            e = t.map(i);
                        return t.push(s.a), t.toString = (() => `hsla(${e[0]}, ${e[1]}%, ${e[2]}%, ${s.a.toFixed(1)})`), t
                    },
                    toRGBA() {
                        const t = v(s.h, s.s, s.v),
                            e = t.map(i);
                        return t.push(s.a), t.toString = (() => `rgba(${e[0]}, ${e[1]}, ${e[2]}, ${s.a.toFixed(1)})`), t
                    },
                    toCMYK() {
                        const t = function(t, e, o) {
                                const n = v(t, e, o),
                                    ...
                                    r = n[2] / 255;
                                let a, c, l, p;
                                return [100 * (c = 1 === (a = d(1 - i, 1 - s, 1 - r)) ? 0 : (1 - i - a) / (1 - a)), 100 * (l = 1 === a ? 0 : (1 - s - a) / (1 - a)), 100 * (p = 1 === a ? 0 : (1 - r - a) / (1 - a)), 100 * a]
                            }(s.h, s.s, s.v),
                            e = t.map(i);
                    ...
                    toHEX() {
                        ...
                        return t.toString = (() => {
                            const e = s.a >= 1 ? "" : Number((255 * s.a).toFixed(0)).toString(16).toUpperCase().padStart(2, "0");
                            return `#${t.join("").toUpperCase()+e}`
                        }), t
                    },
                    clone: () => w(s.h, s.s, s.v, s.a)
                };
            return s
        }
        ...
        function k(t) {
            const e = {
                    ...
                    _tapstart(t) {
                        i(document, ["mouseup", "touchend", "touchcancel"], e._tapstop), i(document, ["mousemove", "touchmove"], e._tapmove), t.preventDefault(), e._tapmove(t)
                    },
                    _tapmove(t) {
                        const o = e.options,
                            n = e.cache,
                            i = o.element,
                            s = e.options.wrapper.getBoundingClientRect();
                        let r = 0,
                            a = 0;
                        if (t) {
                            const e = t && t.touches && t.touches[0];
                            r = t ? (e || t).clientX : 0, a = t ? (e || t).clientY : 0, r < s.left ? r = s.left : r > s.left + s.width && (r = s.left + s.width), a < s.top ? a = s.top : a > s.top + s.height && (a = s.top + s.height), r -= s.left, a -= s.top
                        } else n && (r = n.x * s.width, a = n.y * s.height);
                        o.lockX || (i.style.left = `calc(${r/s.width*100}% - ${i.offsetWidth/2}px)`), o.lockY || (i.style.top = `calc(${a/s.height*100}% - ${i.offsetWidth/2}px)`), e.cache = {
                            x: r / s.width,
                            y: a / s.height
                        }, o.onchange(r, a)
                    },
                    ...
                    update() {
                        ...
                        const n = e.options.wrapper.getBoundingClientRect();
                        e._tapmove({
                            clientX: n.left + t,
                            clientY: n.top + o
                        })
                    ...
                    destroy() {
                        const t = e.options,
                            o = e._tapstart;
                        s([t.wrapper, t.element], "mousedown", o), s([t.wrapper, t.element], "touchstart", o, {
                            passive: !1
                        })
                    }
                },
        ...
        class C {
            constructor(t) {
                this.options = Object.assign({
                    ...
                    parent: void 0,
                    closeWithKey: "Escape"
                }, t), this.options.components.interaction || (this.options.components.interaction = {}), this._initializingActive = !0, this._recalc = !0, this._color = w(), this._lastColor = w(), this._swatchColors = [], this._eventListener = {
                    swatchselect: [],
                    change: [],
                    save: [],
                    init: []
                }, this._preBuild(), this._buildComponents(), this._bindEvents(), this._representation = this.options.defaultRepresentation, this.setColorRepresentation(this._representation), this._finalBuild(), this._rePositioningPicker();
                const e = this.options.swatches;
                e && e.length && e.forEach(t => this.addSwatch(t));
                const o = this._root.app.parentElement;
                requestAnimationFrame(function e() {
                    if (null === o.offsetParent && o !== document.body) return requestAnimationFrame(e.bind(this));
                    this.setColor(this.options.default), t.showAlways && this.show(), this._initializingActive = !1, this._emit("init"), i(window, "resize", () => this._rePositioningPicker())
                }.bind(this))
            }
            _preBuild() {
                ...
                "string" == typeof t.el && (t.el = document.querySelector(t.el)), this._root = function(t) {
                    const e = t.components,
                        o = t.strings,
                        n = t.useAsButton,
                        i = t => t ? "" : 'style="display:none" hidden',
                    ...
                    o = {
                        palette: k({
                            ...
                            onchange(e, o) {
                                ...
                                const r = n.toRGBA().toString();
                                this.element.style.background = r, this.wrapper.style.background = `\n                        linear-gradient(to top, rgba(0, 0, 0, ${n.a}), transparent), \n                        linear-gradient(to left, hsla(${n.h}, 100%, 50%, ${n.a}), rgba(255, 255, 255, ${n.a}))\n                    `, s.comparison || (i.button.style.color = r, s.useAsButton || (i.preview.lastColor.style.color = r)), i.preview.currentColor.style.color = r, t._recalc && t._updateOutput(), i.button.classList.remove("clear")
                            }
                        }),
                        hue: k({
                            lockX: !0,
            ...
            _bindEvents() {
                ...
                e.adjustableNumbers && h(t.interaction.result, !1), this._eventBindings = o
            }
            _rePositioningPicker(objt) {
                if(objt == null) objt = this._root;
                 const t = objt;
                    e = this._root.app,
                    o = t.button.getBoundingClientRect();
                e.style.marginLeft = `${o.left}px`, e.style.marginTop = `${o.top}px`;
                ...
                const s = {
                    ...
                    r = parseInt(getComputedStyle(e).left, 10);
                let a = s[this.options.position];
                const c = n.left - r + a,
                    l = n.left - r + a + n.width;
                "middle" !== this.options.position && (c < 0 && -c < n.width / 2 || l > window.innerWidth && l - window.innerWidth < n.width / 2) ? a = s.middle : c < 0 ? a = s.right : l > window.innerWidth && (a = s.left), i.left = `${a}px`
            }
            _updateOutput() {
            ...
            _clearColor() {
                const t = this._root,
                    e = this.options;
                e.useAsButton || (t.button.style.color = "rgba(0, 0, 0, 0.4)"), t.button.classList.add("clear"), e.showAlways || this.hide(), this._emit("save", null)
            }
            _emit(t) {
            ...
            addSwatch(t) {
                const e = _(t).values;
                if (e) {
                    const t = this._swatchColors,
                        o = this._root,
                        n = w(...e),
                        s = a(`<button  style="color: ${n.toRGBA()}"></button>`);
                    return o.swatches.appendChild(s), t.push({
                        element: s,
                        hsvaColorObject: n
                    }), this._eventBindings.push(i(s, "click", () => {
                        this.setHSVA(...n.toHSVA(), !0), this._emit("swatchselect", n)
                    })), !0
                }
                return !1
            }
            ...
            applyColor() {
                ...
                o.lastColor.style.color = i, this.options.useAsButton || (n.style.color = i), n.classList.remove("clear"), this._lastColor = this._color.clone(), this._initializingActive || t || this._emit("save", this._color)
            }
            destroy() {
                this._eventBindings.forEach(t => s(...t)), Object.keys(this.components).forEach(t => this.components[t].destroy())
            }
            destroyAndRemove() {
                this.destroy();
            ...
            show(objt) {
                ...
                if (!this.options.disabled) return this._root.app.classList.add("visible"), this._rePositioningPicker(objt), this
            }
            isOpen() {
            ...
            setHSVA() {
                ...
                a.update(0, p);
                const h = c.options.wrapper.offsetHeight * n;
                c.update(0, h);
                const u = l.options.wrapper,
                    d = u.offsetWidth * (e / 100),
                    f = u.offsetHeight * (1 - o / 100);
                return l.update(d, f), this._color = w(t, e, o, n), this._recalc = s, this._recalc && this._updateOutput(), i || this.applyColor(), !0
            }
            setColor(t) {
                let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                ...
                if (n) {
                    ...
                    if (!s.hidden)
                        for (const t of o) t.classList[t === s ? "add" : "remove"]("active");
        ...
        }, C.create = (t => new C(t)), C.version = "0.4.3";
        e.default = C
    }]).default
});
